---
layout: default
title: ELSYS - ERS CO2 Lite
parent: Sensors
---

<img src="https://github.com/hslu-ige-laes/lora-devices-ttn/raw/master/docs/sensors/elsys-ers-co2-lite_01.png" width="250" align="right" class="inline"/>

# ELSYS - ERS CO2 Lite
{: .no_toc }

- Manufacturer: <a href="https://www.elsys.se/" target="_blank">ELSYS</a>
- Product: <a href="https://www.elsys.se/en/ers-co2-lite/" target="_blank">ERS CO2 Lite (ERS-CO2-LI)</a>

The ELSYS ERS CO2 Lite is an indoor room sensor to measure temperature, humidity and CO<sub>2</sub>. It is the reduced "Lite" variant of the ERS series (no light- and motion sensor).
...
- Indoor device
- Price ca. EUR 186.- (29.06.2026)
- Sensors
  - **Temperature**, 0 ... +50 [°C], ± 0.5 °C, Resolution 0.1 °C
  - **relative Humidity**, 0 ... 85[%rH], ± 2 ... 4 %rH, Resolution 1 %rH
  - **CO<sub>2</sub>**, 0 ... 10'000 [ppm], ± 50 ppm + 3 % of measurement value, NDIR, ABC self-calibration
- Power Supply: 2 × AA Lithium (Li-SOCl₂, 3.6 V), user replaceable
...
- Configuration: NFC (ELSYS Sensor Settings App)
- Size: 76 × 76 × 23 mm
- Weight: ca. 60 g (without batteries)

---

## Documents / Links
- [ERS CO2 Lite product page (elsys.se)](https://www.elsys.se/en/ers-co2-lite/)
- [ERS CO2 Lite datasheet (PDF)](https://elsys.se/public/datasheets/ERS_CO2_Lite_datasheet.pdf)
...
2. Insert the batteries (2 × AA 3.6 V Lithium, type ER14505). If only one battery is used, it must go into slot `A` — for the CO2 models two batteries are recommended
...
5. After a successful join the sensor enters sampling mode and the LED flashes **green** on every transmission
...
ELSYS uses one universal payload decoder for all its devices. The decoder below is the official ELSYS/TTN decoder, extended with a mapping that renames the relevant fields of the ERS CO2 Lite to the data point convention used in this documentation (see table above).
...
function decodeUplink(input) {
  ...
  // Map the ERS CO2 Lite fields to the documentation data point convention
